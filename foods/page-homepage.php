...
<div class="blog-posts">
	<div class="container">
		<h2 class="title-lg text-center mb-4">Tin mới câp nhật</h2><!-- End .title-lg text-center -->
					...
					<div class="owl-item active" >
						<article class="entry">
							<figure class="entry-media">
								<a href="<?php esc_url($featured_img_url); ?>">
							...
							<div class="entry-body text-center">
								<div class="entry-meta">
									<a href="#"><?=$post_date ;?></a>, <?=$comment_count?> Comments
								</div><!-- End .entry-meta -->
