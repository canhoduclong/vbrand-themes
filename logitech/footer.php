		...
		<footer class="footer footer-2">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="widget widget-about">
                                <img src="<?=get_template_directory_uri()?>/assets/images/logo-footer.png" class="footer-logo" alt="Footer Logo" width="82" height="25">
                                <p>Chúng tôi chuyên cung cấp các thiết bị điện tử chuyên nghiệp, đáp ứng nhu cầu người sử dụng </p>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <p class="footer-copyright">quyền @ 2024, Thiết kế bởi vBrand.</p>
