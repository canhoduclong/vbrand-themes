                                            ...
                                            <div class="col-md-4">
                                                <div class="banner banner-overlay">
                                                    <a href="category.html" class="banner banner-menu">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/menu/banner-1.jpg" alt="Banner">
                                            ...
                                            <div class="col-md-6">
                                                <div class="banner banner-overlay">
                                                    <a href="category.html">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/menu/banner-2.jpg" alt="Banner">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-cart-products">
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="<?=get_template_directory_uri()?>/assets/images/products/cart/product-1.jpg" alt="product">
                                            </a>
                                        </figure>
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                    </div><!-- End .product -->
                                    ...
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="<?=get_template_directory_uri()?>/assets/images/products/cart/product-2.jpg" alt="product">
                                            </a>
                                        </figure>
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                    </div><!-- End .product -->
                                ...
                                <div class="row justify-content-center">
                                        ...
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/products/product-4-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/products/product-4-2-thumb.jpg" alt="product desc">
                                                    </a>

                                                    <a href="#">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/products/product-4-3-thumb.jpg" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/products/product-5-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/products/product-5-2-thumb.jpg" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
                                            </div><!-- End .product-body -->
                                        </div><!-- End .product -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/products/product-8-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/products/product-8-2-thumb.jpg" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
                                            </div><!-- End .product-body -->
                                        </div><!-- End .product -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/products/product-9-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/products/product-9-2-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/products/product-9-3-thumb.jpg" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
                                            </div><!-- End .product-body -->
                                        </div><!-- End .product -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/products/product-11-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/products/product-11-2-thumb.jpg" alt="product desc">
                                                    </a>

                                                    <a href="#">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/products/product-11-3-thumb.jpg" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
                                            </div><!-- End .product-body -->
                                        </div><!-- End .product -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/products/product-13-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/products/product-13-2-thumb.jpg" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
                                            </div><!-- End .product-body -->
                                        </div><!-- End .product -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/products/product-14-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/products/product-14-2-thumb.jpg" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="<?=get_template_directory_uri()?>/assets/images/products/product-14-3-thumb.jpg" alt="product desc">
                                                    </a>
                                                </div><!-- End .product-nav -->
                                            </div><!-- End .product-body -->
                                        </div><!-- End .product -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="<?=get_template_directory_uri()?>/assets/images/products/product-15.jpg" alt="Product image" class="product-image">
                                                </a>
	            	...
	            	<div class="row">
	            		<div class="col-sm-6 col-lg-3">
	            			<div class="widget widget-about">
	            				<img src="<?=get_template_directory_uri()?>/assets/images/logo.png" class="footer-logo" alt="Footer Logo" width="105" height="25">
	        ...
	        <div class="footer-bottom">
	        	<div class="container">
	        		...
	        		<figure class="footer-payments">
	        			<img src="<?=get_template_directory_uri()?>/assets/images/payments.png" alt="Payment methods" width="272" height="20">
