		...
		<footer class="footer"> 
			...
			<div class="cta bg-image bg-dark pt-4 pb-5 mb-0" style="background-image: url(<?=get_template_directory_uri()?>/assets/images/demos/demo-4/bg-5.jpg);">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-sm-10 col-md-8 col-lg-6">
                            <div class="cta-heading text-center">
                                <h3 class="cta-title text-white">Đăng ký nhận tin từ chúng tôi</h3>
                                <p class="cta-desc text-white">Và nhận <span class="font-weight-normal">Thông tin ưu đãi</span> từ chúng tôi</p>
                            </div><!-- End .text-center -->
                        
                            <form action="#">
                                <div class="input-group input-group-round">
                                    <input type="email" class="form-control form-control-white" placeholder="Nhập Enail của bạn" aria-label="Email Adress" required="">
				...
				<div class="col-10">
					<div class="row no-gutters bg-white newsletter-popup-content">
						...
						<div class="col-xl-2-5col col-lg-5 ">
							<img src="<?=get_template_directory_uri()?>/assets/images/popup/newsletter/img-1.jpg" class="newsletter-img" alt="newsletter">
						</div>
					</div>
				</div>
			</div>
